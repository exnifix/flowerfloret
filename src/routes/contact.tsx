    ...
    <Layout>
      ...
      <section className="pb-24">
        <div className="mx-auto max-w-3xl px-6 lg:px-10">
          ...
          >
            <Field label="Your Name" placeholder="How shall we greet you?" />
            <div className="grid sm:grid-cols-2 gap-5">
              <Field label="Email" type="email" placeholder="you@example.com" />
              <Field label="Phone" placeholder="Optional" />
            </div>
            <Field label="Occasion" placeholder="A birthday, an apology, a Tuesday…" />
            <div>
            ...
            {sent && (
              <p className="text-center text-sm text-rose font-italic italic animate-fade-up">
                Thank you — we'll bloom into your inbox very soon.
              </p>
            )}
          </form>
